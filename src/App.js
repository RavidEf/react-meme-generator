        ...
        <div>
          <img
            ...
            src={
              finalUrl
                ? finalUrl
                : `https://api.memegen.link/images/${memeGen.length > 0 ? memeGen : 'slap'}/${userInputUpper.length > 0 ? encodeURIComponent(userInputUpper) : '_'}/${userInputLow.length > 0 ? encodeURIComponent(userInputLow) : '_'}.png`
            }
            alt="Generated meme"
          />
        </div>
